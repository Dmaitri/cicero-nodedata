...
class MetadataHelper {
    ...
    static getMetaDataFromName(modelName) {
    ...
    static getMetaDataFromDecoratorType(target, dType) {
        ...
        for (let d in decoratorsData) {
            ...
            if (meta[constants_1.MetadataConstants.CLASSDECORATOR_PROPKEY] && meta[constants_1.MetadataConstants.CLASSDECORATOR_PROPKEY].modelType === dType) {
                decoratorTypeData.push(meta[constants_1.MetadataConstants.CLASSDECORATOR_PROPKEY]);
            }
        }
...
function resetFieldDecoratorCache() {
    _decoratorsCache = {};
}
exports.resetFieldDecoratorCache = resetFieldDecoratorCache;
