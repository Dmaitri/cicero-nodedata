...
var schemaNameModel = {};
exports.pathRepoMap = {};
exports.repoFromModel = {};
function updateModelEntity(schemaName, entity, model, schema) {
    if (!schemaNameModel[schemaName]) {
        schemaNameModel[schemaName] = { entity: entity, model: model, schema: schema };
    }
}
exports.updateModelEntity = updateModelEntity;
function getEntity(schemaName) {
    if (!schemaNameModel[schemaName])
        return null;
