...
class DynamicSchema {
    ...
    getSchema() {
        ...
        utils_1.resetFieldDecoratorCache();
    ...
    parse(target) {
        ...
        for (var field in metaDataMap) {
            ...
            if (fieldMetadata.params && fieldMetadata.params.primary) {
        ...
        exports._arrayPropListSchema[this.schemaName] = arrayProps;
        return schema;
    }
    ...
    getSchemaTypeForParam(fieldMetadata) {
        var schemaType = this.getSchemaTypeForType(fieldMetadata.getType());
        return fieldMetadata.propertyType.isArray ? (this.isJsonMapTypeProp(fieldMetadata) ? {} : [schemaType]) : schemaType;
    ...
    isJsonMapTypeProp(fieldMetadata) {
        if (!fieldMetadata.params) {
            return false;
        }
        return fieldMetadata.params.storageType === index_1.StorageType.JSONMAP;
    }
}
