...
let TopicRepository = class TopicRepository extends dynamic_repository_1.DynamicRepository {
    doTestFindWhere(query) {
        return this.findWhere(query);
    }
};
TopicRepository = __decorate([
    decorators_1.repository({ path: 'topic', model: topic_1.topic }), 
