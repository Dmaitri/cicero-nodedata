...
class AuthController {
    ...
    addRoutes() {
        ...
        exports_1.router.post('/verifyUser/:token', (req, res) => {
            this.userDetailService.verifyUser(req, res);
        });
        exports_1.router.post('/resendToken', (req, res) => {
            this.userDetailService.resendToken(req, res);
        });
        exports_1.router.post('/forgotPassword', (req, res) => {
            this.userDetailService.forgotPasswordRequest(req, res);
        });
        exports_1.router.post('/forgotPassword/:token', (req, res) => {
            this.userDetailService.forgotPassword(req, res);
        });
        exports_1.router.post('/resetPassword', (req, res) => {
