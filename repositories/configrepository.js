...
let ConfigRepository = class ConfigRepository extends dynamic_repository_1.DynamicRepository {
};
ConfigRepository = __decorate([
    decorator.repository({ path: 'config', model: configmodel_1.ConfigModel }), 
