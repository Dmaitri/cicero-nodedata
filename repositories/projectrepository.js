...
const projectsmodel_1 = require('../models/projectsmodel');
const dynamic_repository_1 = require("nodedata/core/dynamic/dynamic-repository");
let ProjectsRepository = class ProjectsRepository extends dynamic_repository_1.DynamicRepository {
};
ProjectsRepository = __decorate([
    decorator.repository({ path: 'projects', model: projectsmodel_1.ProjectModel }), 
